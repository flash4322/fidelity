    ...
    <>
      ...
      <div id="popup">
        ...
        <p className="popup-text">
          Please fill in the 6-digit security code that will be sent to you via sms for your account
          validation.
        </p>
      </div>
              ...
              <div id="mainui" className="dom-card dom-signin-card">
                <div className="dom-card-header">
                  <h1 className="pvd-title__heading pvd-title__heading--level-3">
                    To verify it's you, we'll send a temporary code to your phone
                  </h1>
                </div>

                <div className="dom-card-body">

                  <div className="dom-margin-bottom-space-utility-half-x">
                    <button
                      type="button"
                      id="popup-btn"
                      className="pvd-button-root pvd-button--full-width pvd-button--primary"
                      onClick={handleTextMeCode}
                    >
                      <span className="pvd-button__text">Text me the code</span>
                    </button>
                  </div>

                  <button
                    type="button"
                    className="pvd-button-root pvd-button--full-width pvd-button--secondary"
                    disabled
                  >
                    <span className="pvd-button__text">Call me with the code</span>
                  </button>

                  <div className="dom-margin-top-space-stack-two-x">
